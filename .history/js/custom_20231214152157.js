...
// the function incrementally removes the hidden to visible first on the whole .progress and then on each part of the .progress-bar
...
addEventListener("click", (e) => {
    ...
    setTimeout(() => {santaValidation.removeAttribute("hidden")}, 4000);santaValidationBar.animate({ width: "100%" }, 7000);
    setTimeout(() => {santaValidation.style.width = "100%"}, 7000);
