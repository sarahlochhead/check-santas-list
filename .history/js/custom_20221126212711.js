...
addEventListener('submit', (event) => {
    ...
    // incrementally remove the hidden attribute on each part of the progress bar.
        ...
        setTimeout(() => {progressBarTwo.removeAttribute("hidden")}, 3000);
        setTimeout(() => {progressBarThree.removeAttribute("hidden")}, 4000;
        setTimeout(() => {progressBarFour.removeAttribute("hidden")}, 5000);
