...
addEventListener('submit', (event) => {
    ...
    // incrementally remove the hidden attribute on each part of the progress bar.
        ...
        setTimeout(() => {progressBarOne.removeAttribute("hidden")}, 2000);
        setTimeout(() => {progressBarTwo.removeAttribute("hidden")}, 1500);
        setTimeout(() => {progressBarThree.removeAttribute("hidden")}, 3500);
        setTimeout(() => {progressBarFour.removeAttribute("hidden")}, 1000);
