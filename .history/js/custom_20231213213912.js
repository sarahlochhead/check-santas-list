...
const elfVerification = document.querySelector(".modal-body > div:nth-child(2) > section");

const elfVerificationBar = document.querySelector(".modal-body > div:nth-child(2) > section .progress-bar");
...
addEventListener('click', (event) => {
    ...
    elfVerificationBar.classList.add()
